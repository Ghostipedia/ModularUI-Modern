...
public class DoubleArrayMath {
    ...
    public static double[] applyEach(double[] src, DoubleUnaryOperator op, double @Nullable [] res) {
        if (res == null) res = new double[src.length];
        int n = Math.min(src.length, res.length);
    ...
    public static double[] applyEach(double[] src, double[] operands, DoubleBinaryOperator op,
                                     double @Nullable [] res) {
        if (src.length != Array.getLength(operands)) {
    ...
    public static double[] applyEach(double[] src, double[] operands1, double[] operands2, DoubleTernaryOperator op,
                                     double @Nullable [] res) {
    ...
    public static double reduce(double[] src, DoubleBinaryOperator op) {
