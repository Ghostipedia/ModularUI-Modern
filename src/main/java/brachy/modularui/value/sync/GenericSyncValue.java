...
public class GenericSyncValue<B extends ByteBuf, T> extends AbstractGenericSyncValue<B, T, GenericSyncValue<B, T>> {
    ...
    public GenericSyncValue(@NotNull Class<T> type,
        ...
        this.deserializer = nullable ? IByteBufAdapter.wrapNullSafe(deserializer) : deserializer;
        this.serializer = nullable ? IByteBufAdapter.wrapNullSafe(serializer) : serializer;
     ...
     * @return builder
     */
    public static <B extends ByteBuf, T> Builder<B, T> builder(Class<T> type) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <B extends ByteBuf, T> Builder<B, T> rawTypeBuilder(Class<?> type) {
        return new Builder<>((Class<T>) type);
    }
     ...
     * @return builder
     */
    public static <B extends ByteBuf, T> Builder<B, T> notNullBuilder() {
    ...
    public static class Builder<B extends ByteBuf, T> {
         ...
         * <p>
         * By default, the {@link #serializer(StreamEncoder)} and {@link #deserializer(StreamDecoder)} function are called to
        ...
        /**
         * Sets an adapter. This combines {@link #deserializer(StreamDecoder)}, {@link #serializer(StreamEncoder)} and
         * {@link #equals(EqualityTest)} into one method.
         *
         * @param adapter byte buf adapter
         * @return this builder
         * @see #deserializer(StreamDecoder)
